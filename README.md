...
Visit `http://localhost:3000` and sign in with your admin credentials from the `.env` file (ADMIN_PASSWORD).
...
# E2E Test Credentials (local development only - NEVER add to production)
E2E_TEST_EMAIL="..."
E2E_TEST_PASSWORD="..."
```
